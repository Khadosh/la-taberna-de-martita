...
- **Diario de sesión traducido**, incluido el formato de fecha, que se elige por idioma en vez de estar fijo en `es-ES`.
- **Seed en inglés**: la campaña, los personajes, los PNJs, el botín y las notas de sesión. El documento con capturas está en inglés y el contenido de demo también tiene que estarlo — si no, la pantalla dice "The Curse of Waterdeep" y la nota abajo está en español.
