...
function HumanoidSVG() {
  return (
    <svg viewBox="0 0 60 170" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      <path d="M10 31 Q15 28 30 27 Q45 28 50 31 L48 39 Q38 37 30 38 Q22 37 12 39 Z" fill="#222" stroke="#4a4130" strokeWidth="1.2" />
      <path d="M12 39 L16 84 Q30 88 44 84 L48 39 Q38 37 30 38 Q22 37 12 39 Z" fill="#1c1c1c" stroke="#3a3228" strokeWidth="1.2" />
    ...
    >
      <div className="w-full h-full flex items-center justify-center overflow-hidden rounded-sm pointer-events-none">
        {isEmpty ? (
          ...
          <div className="w-[58%] h-[58%] text-amber-800/50 flex items-center justify-center">
            {SLOT_SVG[slotKey]}
          </div>
        )}
      </div>
